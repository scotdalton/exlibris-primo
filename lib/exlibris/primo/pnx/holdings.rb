      ...
      module Holdings
        ...
        def holdings
          @holdings ||=  xml.root.xpath("display/availlibrary").collect do |availlibrary|
            ...
            title = self.display_title if self.class.respond_to? :display_title
            author = self.display_creator if self.class.respond_to? :display_creator
            display_type = self.display_type if self.class.respond_to? :display_type
